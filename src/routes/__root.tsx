...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI business intelligence platform: discover, score and prioritize high-value business opportunities across Hyderabad and beyond." },
